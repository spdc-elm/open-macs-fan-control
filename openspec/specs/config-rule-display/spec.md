...
Define the behavior for displaying a human-readable summary of the active automatic-control configuration rules in the menu bar panel, so users can verify temperature-to-RPM mappings at a glance without inspecting the raw config file.
